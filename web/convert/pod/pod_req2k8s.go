...
func (pc *Req2K8sConvert) getK8sEnvFrom(podReqEnvsFrom []pod_req.EnvVarFromResource) []corev1.EnvFromSource {
...
func (pc *Req2K8sConvert) getK8sEnv(podReqEnv []pod_req.EnvVar) []corev1.EnvVar {
